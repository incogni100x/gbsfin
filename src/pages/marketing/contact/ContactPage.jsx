      ...
      <div className="grid gap-12 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1fr)] lg:gap-20">
        <div>
          ...
          <div className="mt-8 grid gap-6 border-t border-[var(--color-separator-border)] pt-6">
            ...
            <div>
              <h2 className="text-headline-medium">Available around the clock</h2>
        ...
        >
          <div className="grid gap-5">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <Input isRequired label="First name" name="firstName" placeholder="Your first name" />
              <Input isRequired label="Last name" name="lastName" placeholder="Your last name" />
            </div>
            <Input
              isRequired
              label="Email address"
              ...
              type="email"
            />
            <Input isRequired label="Subject" name="subject" placeholder="How can we help?" />
            <div className="grid gap-1">
              <label
                className="text-body-medium text-[var(--color-text-primary)]"
                htmlFor="contact-message"
              >
                Message <span className="text-[var(--color-text-error-primary)]">*</span>
              </label>
              <textarea
